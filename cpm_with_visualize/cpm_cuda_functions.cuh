#ifndef CPM_CUDA_FUNCTIONS_CUH
#define CPM_CUDA_FUNCTIONS_CUH
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
#include <math.h>
...
// Funzione risolvere il sistema lineare A * x = b usando LAPACK
void solve_linear_system(double** chemical, double** E_field_x, double** E_field_y, int size);
// Funzione per risolvere il sistema lineare A * x = b usando cuda
